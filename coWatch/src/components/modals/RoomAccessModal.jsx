        ...
        <div className="w-full max-w-115 rounded-2xl border border-indigo-200/20 bg-linear-to-b from-[#101a44]/95 to-[#081433]/95 p-6 shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-indigo-200/20 bg-white/3 p-4">
              ...
              <div className="flex items-center gap-3">
                <p className="min-w-25 text-3xl text-white">
                  {captcha.a} + {captcha.b} = ?
                </p>
                ...
                <button
                  ...
                  className="h-11 rounded-lg bg-slate-600 px-4 text-sm font-semibold text-white hover:bg-slate-500"
                >
                  Verify
                </button>
              </div>
          ...
          <div className="mt-6 flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="w-[58%] rounded-xl bg-linear-to-r from-cyan-400 to-fuchsia-500 px-4 py-3 text-lg font-semibold text-white shadow-[0_10px_24px_rgba(69,147,255,.35)] hover:brightness-110"
            >
